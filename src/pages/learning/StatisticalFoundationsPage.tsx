    ...
    <div className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
      ...
      <div className="mt-6">
        <SectionHeading
          ...
          subtitle="A plain-language introduction to the quantitative concepts you'll encounter when working with education data — descriptive statistics, confidence intervals, effect sizes, reliability, and more. No formulas required."
        />
      </div>
      ...
      <section id="descriptive-statistics" className="mt-16 scroll-mt-24">
        ...
        <div className="mt-4 max-w-none space-y-4 text-sm leading-relaxed text-slate-600">
          <p>
            ...
            of the heavy lifting: the <strong className="text-slate-900">mean</strong>,
        ...
        <div className="mt-4 space-y-4 text-sm leading-relaxed text-slate-600">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card hover>
              ...
              <p className="mt-2 text-sm text-slate-600">
                The full guide to working with OMI data — de-identification, data preparation,
